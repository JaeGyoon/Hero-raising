...
{
    [RequireComponent(typeof(PixelFantasy.Common.Scripts.Creature))]
    [RequireComponent(typeof(Animator))]
    public class InanimateControls : MonoBehaviour
    {
        private PixelFantasy.Common.Scripts.Creature _creature;
        private Animator _animator;

        public void Start()
        {
            _creature = GetComponent<PixelFantasy.Common.Scripts.Creature>();
